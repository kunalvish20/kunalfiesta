    ...
    <div className={['flex items-center mb-3 gap-2 w-full', className || ''].join(' ')}>
      ...
      <div className="flex items-center gap-2 min-w-0">
        ...
        {showCompareButton && (
          <Link
            href="/compare"
            className="inline-block ml-1 bg-blue-950 text-blue-400 border border-blue-400 border-b-2 font-medium overflow-hidden relative px-2.5 py-1.5 rounded-md hover:brightness-150 hover:border-t-2 hover:border-b active:opacity-75 outline-none duration-300 group text-xs"
          >
            <span className="bg-blue-400 shadow-blue-400 absolute -top-[150%] left-0 inline-flex w-48 h-[3px] rounded-md opacity-50 group-hover:top-[150%] duration-500 shadow-[0_0_10px_10px_rgba(0,0,0,0.3)]"></span>
            Compare Models
          </Link>
        )}
      </div>
