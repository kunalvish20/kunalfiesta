...
export const ChatInterface = forwardRef<ChatInterfaceRef, { hideInput?: boolean }>(function ChatInterface(
  ...
  const getBrandFromModel = (model?: AiModel): { src: string; alt: string } => {
    ...
    if (!model) return { src: fallback, alt: 'kunal ai' }
    ...
    return { src: fallback, alt: 'kunal ai' }
  }
    ...
    >
      ...
      <motion.div
        className={`absolute -inset-2 rounded-full blur-lg ${
          isDark
            ? "bg-gradient-radial from-blue-500/40 via-indigo-600/20 to-transparent"
            : "bg-gradient-radial from-blue-400/40 via-indigo-500/20 to-transparent"
        }`}
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.6, 0.9, 0.6],
      ...
      <motion.div
        className={`absolute inset-0 rounded-full ${
          isDark
            ? "bg-gradient-radial from-blue-400/90 via-blue-500/80 to-blue-600/90"
            : "bg-gradient-radial from-blue-300/90 via-blue-400/80 to-blue-500/90"
        } shadow-2xl`}
        animate={{
          scale: [1, 1.05, 1],
        }}
      ...
      <motion.div
        className={`absolute inset-1 rounded-full ${
          isDark
            ? "bg-gradient-radial from-blue-300/80 via-blue-400/60 to-transparent"
            : "bg-gradient-radial from-blue-200/80 via-blue-300/60 to-transparent"
        }`}
        animate={{
          rotate: [0, 360],
          scale: [1, 1.1, 1],
      ...
      {/* Core light */}
      <motion.div
        className={`absolute inset-3 rounded-full ${isDark ? "bg-blue-200/90" : "bg-blue-100/90"} backdrop-blur-sm`}
        animate={{
          opacity: [0.8, 1, 0.8],
        }}
        transition={{
          ...
          <div className="relative w-full max-w-4xl">
            ...
            <div
              ...
              className={`pointer-events-none absolute -inset-x-10 -top-6 h-[520px] rounded-[40px] blur-2xl -z-10 ${
                isDark
                  ? 'bg-[radial-gradient(60%_60%_at_50%_30%,rgba(59,130,246,0.08)_0%,rgba(79,70,229,0.06)_25%,rgba(0,0,0,0)_70%)]'
                  : 'bg-[radial-gradient(60%_60%_at_50%_30%,rgba(96,165,250,0.20)_0%,rgba(147,197,253,0.14)_30%,rgba(255,255,255,0)_75%)]'
              }`}
            />
              ...
              <h2
                className={`${
                  isDark
                    ...
                    : 'text-transparent bg-clip-text bg-gradient-to-r from-blue-900 via-blue-800 to-blue-700'
                } text-lg lg:text-2xl font-semibold tracking-tight`}
              >
                What do you want to ask?
              </h2>
              <p className={`${isDark ? 'text-white/60' : 'text-blue-900/70'} text-xs lg:text-sm mt-1`}>
              ...
              {[
                ...
                <motion.button
                  ...
                  className={`group relative overflow-hidden inline-flex w-auto max-w-full text-left px-4 lg:px-6 py-3 lg:py-4 rounded-2xl text-sm lg:text-base font-medium transition-all duration-300 backdrop-blur-lg shadow-md hover:shadow-xl will-change-transform ${
                    isDark
                      ? "text-white/85 hover:text-white bg-gradient-to-br from-black/35 via-black/25 to-black/15 border border-white/10 hover:border-white/20 ring-1 ring-blue-400/10 hover:ring-blue-400/20 shadow-[0_10px_30px_-10px_rgba(0,0,0,0.6)]"
                      : "text-blue-950/80 hover:text-blue-950 bg-gradient-to-br from-blue-50/80 to-blue-100/70 border border-blue-200/70 hover:border-blue-300"
                  }`}
                ...
                >
                  ...
                  <span
                    className={`absolute left-0 top-0 bottom-0 w-1 rounded-l-2xl ${
                      isDark
                        ? 'bg-gradient-to-b from-blue-400/40 via-blue-500/25 to-indigo-400/40'
                        : 'bg-gradient-to-b from-blue-400/60 via-blue-300/40 to-indigo-400/50'
                    }`}
                  />
                  ...
                  <span
                    className={`pointer-events-none absolute inset-0 -z-0 opacity-0 group-hover:opacity-100 blur-md transition-opacity duration-300 ${
                      isDark ? 'bg-[radial-gradient(40%_60%_at_30%_50%,rgba(59,130,246,0.12)_0%,rgba(0,0,0,0)_70%)]' : 'bg-[radial-gradient(40%_60%_at_30%_50%,rgba(96,165,250,0.25)_0%,rgba(255,255,255,0)_70%)]'
                    }`}
                  />
                  ...
                  <span
                    className={`pointer-events-none absolute left-2 right-2 top-0 h-px opacity-50 ${
                      isDark ? 'bg-white/15' : 'bg-blue-400/30'
                    }`}
                  />
