            ...
            <div className="pb-10">
              ...
              {imagePreview ? (
                <div className="grid grid-cols-[96px_1fr] gap-3 p-3 pr-4">
                  <div className="relative h-[96px] w-[96px] rounded-xl overflow-hidden border border-blue-700 dark:border-blue-400 shadow-sm">
                    <Image
                    ...
                    <button
                      onClick={handelClose}
                      className="absolute top-1.5 right-1.5 inline-flex items-center justify-center h-6 w-6 rounded-full bg-blue-700 dark:bg-blue-400 text-white dark:text-black hover:bg-blue-800 dark:hover:bg-blue-500 border border-blue-600 dark:border-blue-300"
                      aria-label="Remove image"
                    >
                      <X className="w-3.5 h-3.5" />
                    </button>
                  </div>
                  <div className="relative rounded-xl bg-blue-900 dark:bg-blue-700 border border-blue-700 dark:border-blue-400 backdrop-blur-sm">
                    <Textarea
                      id="ai-input-04"
                      value={value}
                      placeholder=""
                ...
                <div className="relative">
                  <Textarea
                    ...
                    value={value}
                    placeholder=""
                    className="w-full rounded-2xl rounded-b-none px-4 py-3 bg-blue-900 dark:bg-blue-700 border border-blue-700 dark:border-blue-400 text-white resize-none focus-visible:ring-0 leading-[1.2]"
                    ref={textareaRef}
                    onKeyDown={(e) => {
                      if (e.key === 'Enter' && !e.shiftKey) {
                        e.preventDefault();
              ...
              {browserSupportsSpeechRecognition && (
                <button
                  ...
                  className={cn(
                    ...
                    listening
                      ? 'bg-blue-500 text-white shadow-lg shadow-blue-500/25 animate-pulse scale-105'
