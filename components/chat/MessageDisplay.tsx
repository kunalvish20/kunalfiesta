  ...
  return (
    <div className="flex items-start gap-2 justify-end">
      ...
      <button
        ...
        className="mt-1 h-6 w-6 shrink-0 inline-flex items-center justify-center rounded-md border border-white/10 bg-white/5 hover:bg-blue-500/20 hover:border-blue-300/30 text-zinc-300 hover:text-blue-100 transition-colors"
        title="Edit message"
