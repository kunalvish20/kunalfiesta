          ...
          <div className="mb-6 px-4">
            ...
            >
              ...
              <span className="text-sm text-white/90">
                ...
                <span className="font-bold ml-1">Kunal </span>
              </span>
            </a>
          </div>
        )}
...
export function SimpleThreadSidebar({ isDark, sidebarOpen, onClose, onNewChat }: SimpleSidebarProps) {
  ...
  className={cn(
    ...
    isDark
      ...
      : 'bg-blue-200 hover:bg-blue-300 text-blue-800 border-blue-400',
  )}
  variant="outline"
>
  ...
  className={cn(
    ...
    searchFocused || search.length > 0
      ? 'w-full ring-2 ring-offset-0 ring-blue-500/20 dark:ring-blue-500/20'
      : 'w-32',
  )}
>
