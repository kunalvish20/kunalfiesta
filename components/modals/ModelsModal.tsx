...
export default function ModelsModal({
  ...
  const filteblueModels = MODEL_CATALOG.filter((m) => {
          ...
          return (
            <div
              ...
              className={`relative group cursor-pointer rounded-2xl border backdrop-blur-sm transition-all duration-300 overflow-hidden ${
                disabled ? 'opacity-40 cursor-not-allowed' : 'hover:scale-[1.02] hover:shadow-2xl hover:shadow-blue-500/5'
              } ${
                selected
                  ? 'border-blue-400/50 bg-gradient-to-br from-blue-950/40 via-zinc-900/90 to-black/70 shadow-2xl shadow-blue-500/20 ring-1 ring-blue-500/20'
            ...
            >
              ...
              {selected && (
                <>
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-500/15 via-blue-500/5 to-blue-500/10 pointer-events-none" />
              ...
              <div className="relative p-4 flex flex-col h-full min-h-[120px]">
                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="flex flex-wrap gap-2">
                    ...
                    {isUnc(m) && (
                      <motion.span 
                        className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-gradient-to-r from-blue-500/25 to-rose-500/25 text-blue-200 text-xs font-bold border border-blue-500/30 shadow-lg shadow-blue-500/10"
                        whileHover={{ scale: 1.05 }}
                      >
                    ...
                    {m.category === 'audio' && (
                      <motion.span 
                        className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-gradient-to-r from-orange-500/25 to-blue-500/25 text-orange-200 text-xs font-bold border border-orange-500/30 shadow-lg shadow-orange-500/10"
                        whileHover={{ scale: 1.05 }}
                      >
                ...
                <div className="mt-auto">
                  <div className={`w-full h-1 rounded-full transition-all duration-300 ${
                    selected 
                      ? 'bg-gradient-to-r from-blue-600 via-blue-400 to-blue-600 shadow-lg shadow-blue-500/40' 
                      : 'bg-gradient-to-r from-zinc-700/80 via-zinc-600/60 to-zinc-700/80'
                  }`} />
                  {selected && (
                    <div className="text-xs text-blue-300 font-semibold mt-1.5 text-center tracking-wide">
                      ✓ SELECTED
                    </div>
                  )}
                </div>
