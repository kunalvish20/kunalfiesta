        ...
        <div className="p-4 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 bg-white/5 border rounded-md text-white placeholder-white/40 focus:outline-none focus:ring-2 transition-colors ${
                nameError
                  ? 'border-blue-400 focus:ring-blue-400/50'
                  : 'border-white/20 focus:border-white/30 focus:ring-[var(--accent-interactive-primary)]/50'
              }`}
              maxLength={50}
              autoFocus
            />
            {nameError && <p className="mt-1 text-xs text-blue-400">{nameError}</p>}
          ...
          <div>
            ...
            <textarea
              ...
              maxLength={1000}
            />
            {promptError && <p className="mt-1 text-xs text-blue-400">{promptError}</p>}
