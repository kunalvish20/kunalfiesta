...
export const ACCENT_COLORS: Record<AccentColor, AccentDefinition> = {
  ...
  crimson: {
    ...
    background: {
      ...
      secondary: 'rgba(59, 130, 246, 0.045)',
    },
    gradient: {
      light:
        'linear-gradient(135deg, #b9cbe0 0%, #5d88c4 22%, #315d94 48%, #1b426e 76%, #112843 100%)',
      dark: 'linear-gradient(0deg, rgba(0,0,0,0.7), rgba(0,0,0,0.7)), radial-gradient(68% 58% at 50% 50%, #2563eb 0%, #1d4ed8 22%, #16386c 40%, #112a53 56%, #0b1f3a 72%, #071520 86%, #040a10 100%)',
    },
  },
  emerald: {
    id: 'emerald',
